...
checkpoint_path = "../../training/unpruned_model/model_epoch_24.pth"
checkpoint = torch.load(checkpoint_path, map_location=device)
model.load_state_dict(checkpoint)
logger.info("Loaded unpruned model checkpoint.")
...
# Evaluate the pruned model using the evaluation function imported from inference.py
mean_iou_per_class, per_class_acc = evaluate_model(
    pruned_model, test_loader, device, save_dir="results"
)
logger.info("Post-pruning evaluation completed.")
