...
# -------------------- Initialize UNET MobileNetV3 Model ---------------------------
def create_model(num_classes=5):
    """Create a UNET MobileNetV3 model with the same architecture used in training"""
    ...
    model = smp.Unet(
        ...
        in_channels=3,
        classes=num_classes,
        activation=None,  # No activation in the model, will apply softmax during inference
    )
...
if __name__ == "__main__":
    print(f"Running inference with pruned UNET MobileNetV3 model on {device}")
