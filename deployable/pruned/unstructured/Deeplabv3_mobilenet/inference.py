...
# -------------------- Check point --------------------
checkpoint_path = (
    "../../../models/pruned_models/unstructured/Deeplabv3_mobilenet_epoch_29.pth"
)
...
def process_image(image_path):
    ...
    with torch.no_grad():
        ...
        if foreground_probs.sum().item() > 0:
            ...
            # Get the class with highest probability among foreground classesAdd 1 to restore original class index (since we ignored background)
